...
const double AnalysisHandlerATLAS_13TeV::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS_13TeV::DR_TAU_TRUTH = 0.2;
...
AnalysisHandlerATLAS_13TeV::~AnalysisHandlerATLAS_13TeV() {
}

void AnalysisHandlerATLAS_13TeV::initialize() {
}

void AnalysisHandlerATLAS_13TeV::finalize() {
}

void AnalysisHandlerATLAS_13TeV::bookAnalysis(std::string analysisName,
                                        Tag_Map whichTags,
...
void AnalysisHandlerATLAS_13TeV::postProcessParticles() {
...
void AnalysisHandlerATLAS_13TeV::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS_13TeV::identifyElectrons() {
...
void AnalysisHandlerATLAS_13TeV::identifyMuons()  {
...
void AnalysisHandlerATLAS_13TeV::tagBJets() {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS_13TeV::bSigEff;
                  break;
              }
          }
...
void AnalysisHandlerATLAS_13TeV::linkObjects() {
...
double AnalysisHandlerATLAS_13TeV::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS_13TeV::electronIDEffLoose(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS_13TeV::electronIDEffMedium(double pt,
                                               double eta) {
    // tuned to https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PLOTS/EGAM-2016-002/fig_01.png
    // https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/CONFNOTES/ATLAS-CONF-2016-024/
...
double AnalysisHandlerATLAS_13TeV::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
    // tuned to https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PLOTS/EGAM-2016-002/fig_01.png
    // https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/CONFNOTES/ATLAS-CONF-2016-024/
    double id_eff_medium = 0.937 - 0.109*exp(1.-pt/21.);
...
double AnalysisHandlerATLAS_13TeV::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_13TeV::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_13TeV::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_13TeV::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_13TeV::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
const AnalysisHandlerATLAS_13TeV::muonDetector AnalysisHandlerATLAS_13TeV::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
